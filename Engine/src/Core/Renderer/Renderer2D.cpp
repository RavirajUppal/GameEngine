...
namespace RealEngine
{
    ...
    void Renderer2D::Init()
	{
		...
		s_Data.QuadShader = Shader::Create("Quad", SHADER_DIR "Quad.vert", SHADER_DIR "Quad.frag");
        s_Data.QuadShader->Bind();
        s_Data.QuadShader->SetInt1Array("u_Textures", samplers, s_Data.MaxTextureSlots);
    ...
    void Renderer2D::BeginScene(const OrthographicCamera& camera)
	{
        ...
        s_Data.QuadShader->Bind();
        s_Data.QuadShader->SetMat4("u_ViewProjection", glm::value_ptr(s_Data.CameraBuffer.ViewProjection));
		StartBatch();
	}
